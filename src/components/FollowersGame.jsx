...
export const FollowersGame = ({ image, numberFollowers}) => {
    return (
        <div>
            <img className='img_game' src={image} alt="" />
            <div className='info'>
                ...
                <p className='info_followers'>{numberFollowers} Followers</p>
            </div>
        </div>
    );
};
...
FollowersGame.propTypes = {
    ...
    numberFollowers: PropTypes.number.isRequired,
};
